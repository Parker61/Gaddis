...
class MyGUI:
    def __init__(self):
        ...
        self.my_button = Button(self.main_window,
                                text='Нажми меня!',
...
class MyGUI:
    def __init__(self):
        ...
        self.quit_button = Button(self.main_window,
                                  text='Выйти',
...
class KiloConverterGUI:
    def __init__(self):
        ...
        self.descr_label = Label(self.mid_frame,
        ...
        self.miles_label = Label(self.mid_frame,
...
class TestAvg:
    def __init__(self):
        ...
        self.test1_label = Label(self.test1_frame,
        ...
        self.test2_label = Label(self.test2_frame,
        ...
        self.test3_label = Label(self.test3_frame,
        ...
        self.result_label = Label(self.avg_frame,
                                  text='Средний балл:')
        self.avg = tk.StringVar() # Для обновления avg_label
        ...
        self.calc_button = Button(self.button_frame,
                                  text='Усреднить',
...
import tkinter as tk
from tkinter.ttk import Frame, Label, Button, Radiobutton
import tkinter.messagebox
...
class MyGUI:
    ...
    def show_choice(self):
        tk.messagebox.showinfo('Выбор', 'Выбран вариант ' +
...
class MyGUI:
    ...
    def show_choice(self):
        ...
        tk.messagebox.showinfo('Выбор', self.message)
...
class MyGUI:
    def __init__(self):
        ...
        # Создать элемент Canvas.
        self.canvas = tk.Canvas(self.main_window, width=200, 
                                height=200)
        # Создать объект Font.
        myfont = tk.font.Font(family='Helvetica', size=18, 
                              weight='bold')
...
# ### Программа 13-23 (gui_demo.py)

# In[21]:


# Эта программа создает простой ГИП со стилизованным модулем ttk.
import tkinter as tk
import tkinter.messagebox
...
class MyGUI:
    def __init__(self):
        self.main_window = tk.Tk()
        self.main_window.geometry("350x300+300+300")
        
        self.frame = Frame(self.main_window)
        
        self.frame.master.title("Окна")
        ...
        lbl = Label(self.frame, text="Введите текст")
        lbl.grid(sticky=tk.W, pady=4, padx=5)
        
        self.area = Text(self.frame)
        self.area.grid(row=1, column=0, columnspan=2, rowspan=4, 
                       padx=5, sticky=tk.E+tk.W+tk.S+tk.N)
        
        abtn = Button(self.frame, text="Обработать", command=self.convert)
        abtn.grid(row=1, column=3)

        cbtn = Button(self.frame, text="Закрыть", command=self.main_window.destroy)
        cbtn.grid(row=2, column=3, pady=4)
        
        hbtn = Button(self.frame, text="Справка", command=self.showmsg)
        hbtn.grid(row=5, column=0, padx=5)

        obtn = Button(self.frame, text="OK", command=self.main_window.destroy)
        obtn.grid(row=5, column=3)        
       
        tk.mainloop()
        
    def showmsg(self):
        tk.messagebox.showinfo('Справка', 'Справочная инфо')
        
    def convert(self):
        text = self.area.get("1.0","end-1c").split(' ')
        res = reduce(lambda aсс, text: aсс + len(text.split()), text, 0)
        self.area.insert("end", f"\nРезультаты: в тексте {res} слов")
